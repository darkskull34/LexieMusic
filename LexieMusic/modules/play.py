...
from LexieMusic.config import ARQ_API_KEY
from LexieMusic.config import BOT_NAME as bn
from LexieMusic.config import DURATION_LIMIT
from LexieMusic.config import UPDATES_CHANNEL as updateschannel
from LexieMusic.config import que
from LexieMusic.function.admins import admins as a
from LexieMusic.helpers.admins import get_administrators
from LexieMusic.helpers.channelmusic import get_chat_id
from LexieMusic.helpers.errors import DurationLimitError
from LexieMusic.helpers.decorators import errors
from LexieMusic.helpers.decorators import authorized_users_only
from LexieMusic.helpers.filters import command
from LexieMusic.helpers.filters import other_filters
from LexieMusic.helpers.gets import get_file_name
from LexieMusic.services.callsmusic import callsmusic
from LexieMusic.services.callsmusic import client as USER
from LexieMusic.services.converter.converter import convert
from LexieMusic.services.downloaders import youtube
from LexieMusic.services.queues import queues
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @LexieXMusic to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
